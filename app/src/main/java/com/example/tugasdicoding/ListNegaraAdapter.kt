...
class ListNegaraAdapter(private val listNegara: ArrayList<Negara>) : RecyclerView.Adapter<ListNegaraAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.item_row_negara, parent, false)
        return ListViewHolder(view)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val (name, description, photo) = listNegara[position]
        ...
        holder.itemView.setOnClickListener {
            ...
            intent.putExtra("EXTRA_NEGARA", listNegara[position]) // Kirim data negara
